#!/bin/bash
#SBATCH --job-name=incremental_compressibility_30_to_50
...
RUN_NAME="incremental_compressibility_30_to_50"
...
accelerate launch \
    ...
    --config.incremental_min_steps=30 \
    --config.incremental_max_steps=50 \
    --config.incremental_constant_epochs=20
